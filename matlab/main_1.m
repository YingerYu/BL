...
% Read the list file
dirID = fopen('/home/mina/Desktop2/yu/data/list_of_dir_dl_1.txt');
...
for dir_count = 1 : 1 : length(dir_list)
    ...
    saveas(5,[dir_name 'Average_CDF_of_TCP_RX_JITTER']);
    ...
    saveas(6,[dir_name 'Average_CDF_of_TCP_TX_JITTER']);
    ...
    saveas(7,[dir_name 'Average_CDF_of_(TCP_RX_time_minus_TCP_TX_time)']);
    ...
    saveas(8,[dir_name 'Total_OOO_block_numbers_VS_OOO_dalay']);
    ...
    xlabel('Delay bins');
    ylabel('Hist');
    saveas(10,[dir_name 'Hist_VS_Delay_bins']);
    ...
    xlabel('Block size');
    ylabel('Hist');
    saveas(11,[dir_name 'Hist_VS_Block_size']);
    ...
    saveas(21,[dir_name 'Scatter figure of reference ratio verous deadline delay.fig']);
